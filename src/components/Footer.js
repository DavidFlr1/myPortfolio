...
const Footer = () => {
  return (
    <Container>
      <Typography tag='p' fontSize={[2]} color={theme.colors.extended.gray500}>Designed by David Flores using React and Gatsby, check the <Link href={'https://github.com/DavidFlr1/myPortfolio'} target={'_blank'} variant='underline' >source code here</Link>.</Typography>
